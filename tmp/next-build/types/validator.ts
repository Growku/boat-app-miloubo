...
// Validate ../../../src/app/api/fuel/latest/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/fuel/latest">> = Specific
  const handler = {} as typeof import("../../../src/app/api/fuel/latest/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
